...
<fieldset style="width:830px; height:auto; background-color:#E2E2E2">
<table width="794">
<tr>
<td>Nº.Cotizacion</td>
...
?></td>
<td width="123">Segundo Nombre</td>
<td width="116"><?php 
$conexion=odbc_connect("sqlserver","sa","TdcSa2011",SQL_CUR_USE_DRIVER); 
$nocotiza=$_REQUEST['nocotiza'];
$doccli=odbc_exec($conexion,"select * from fit.dbo.tb_cotiza where No_cotiza='$nocotiza'");
...
$selnom=odbc_exec($conexion,"select * from fit.dbo.tb_cliente where documento_cliente='$doccli1'");
while($row1=odbc_fetch_array($selnom)){
$nomcli=$row1['nombre2_cliente'];
echo $nomcli;
}
?></td>
</tr>
<tr>
<td width="123">Primer Apellido</td>
<td width="153"><?php 
$conexion=odbc_connect("sqlserver","sa","TdcSa2011",SQL_CUR_USE_DRIVER); 
$nocotiza=$_REQUEST['nocotiza'];
$doccli=odbc_exec($conexion,"select * from fit.dbo.tb_cotiza where No_cotiza='$nocotiza'");
...
<div id="fragment-13">
<table width="805" border="1" id="tbl" style="border-collapse:separate" name=tbl class="label">
          <tr> 
          
			   <th width="50" style="border-collapse:collapse; color:White" border="1">Cod</th>
            <th width="153" style="border-collapse:collapse; color:White" border="1">Vehículo</th>
            <th width="71" style="border-collapse:collapse; color:White" border="1">Valor</font></th>
            <th width="68" style="border-collapse:collapse; color:White" border="1">Cta Inicial</font></th>
            <th width="61" style="border-collapse:collapse; color:White" border="1">Saldo</font></th>
            <th width="37" style="border-collapse:collapse; color:White" border="1">Meses</th>
            <th width="135" style="border-collapse:collapse; color:White" border="1">Cta Mensual</th>
            <th width="161" style="border-collapse:collapse; color:White" border="1">Accesorios</th>
          </tr>
		  ...
		  echo "<td style='border-collapse:collapse; color:White' border='1'>";echo  substr($nomvhc1,5);echo"</td>";
...
<center><input type="submit" value="Actualizar estados" class="botonR"/></center>
</fieldset>
</form>
<div id="result"></div>
</body>
